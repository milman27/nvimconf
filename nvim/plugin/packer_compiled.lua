...
_G.packer_plugins = {
  ...
  powerline = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/powerline",
  ...
  ["vim-closer"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-closer",
    url = "https://github.com/rstacruz/vim-closer"
  },
  ["vim-lsp-cxx-highlight"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-lsp-cxx-highlight",
